...
# ⚠️ Please don't change our credits 𝚃𝙷𝙰𝙽𝙺𝚂 𝚃𝙾 & 𝙳𝙴𝚅 👇🏻
    ...
    ABOUT_TXT = """<b>✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ ᴍᴀᴅᴇ ᴡɪᴛʜ ❤ ʙʏ: <a href=https://t.me/Mrister_Ash>Mʏ ❤</a>
✯ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ: <a href=https://t.me/YourDemandZone>YᴏᴜʀDᴇᴍᴀɴᴅZᴏɴᴇ</a>
...
Yᴏᴜ Aʀᴇ Nᴏᴡ Vᴇʀғɪᴇᴅ ✅,
♻️ Eɴᴊᴏʏ #Uɴʟɪᴍɪᴛᴇᴅ Mᴏᴠɪᴇꜱ & Sᴇʀɪᴇꜱ...\n\n
📝 Nᴏᴛᴇ: Jᴜsᴛ Cʟɪᴄᴋ Aɢᴀɪɴ Oɴ Yᴏᴜʀ Dᴇsɪʀᴇᴅ Cᴏɴᴛᴇɴᴛ Tᴏ Gᴇᴛ Fɪʟᴇ Iɴ Pᴍ ♥️</b>"""
