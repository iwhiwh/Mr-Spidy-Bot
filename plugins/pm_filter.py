...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.answer("⚠ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ⚠\n\nᴀꜰᴛᴇʀ 10 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ\n\nɪꜰ ʏᴏᴜ ᴅᴏ ɴᴏᴛ ꜱᴇᴇ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ᴍᴏᴠɪᴇ / sᴇʀɪᴇs ꜰɪʟᴇ, ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇ\n\n❣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @YourDemandZone", show_alert=True)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Gʀᴏᴜᴘ 🔰', url='https://t.me/+tanY69VLEVs5OGQ1'),
            InlineKeyboardButton('Cʀᴇᴀᴛᴏʀ 😎', url='https://t.me/MR_SPIDY')
        ], [
            InlineKeyboardButton('Hᴇʟᴘ ☢️', callback_data='help'),
            InlineKeyboardButton('Aʙᴏᴜᴛ 🎈', callback_data='about')
         ],[
            InlineKeyboardButton('🛑 Hᴏᴡ ᴛᴏ Usᴇ 🛑', url='https://t.me/YourDemandZone/105')
        ],[
            InlineKeyboardButton('Bᴀᴄᴋ ᴛᴏ Sᴛᴀʀᴛ ↺', callback_data='surprise')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://graph.org/%F0%9D%90%8C%F0%9D%90%AB%F0%9D%90%92%F0%9D%90%8F%F0%9D%90%88%F0%9D%90%83%F0%9D%90%98-05-28-2'),
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://graph.org/%F0%9D%90%8C%F0%9D%90%AB%F0%9D%90%92%F0%9D%90%8F%F0%9D%90%88%F0%9D%90%83%F0%9D%90%98-05-28-2'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/Mr_SPIDY')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='aswin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
async def auto_filter(client, msg, spoll=False):
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            if not files:
                await client.send_message(chat_id=LOG_CHANNEL,f"-🦋 #REQUESTED_CONTENT 🦋-\n\n📝**Content Name** :`{search}`\n**Requested By**: {message.from_user.first_name}\n **USER ID**:{user_id}\n\n🗃️",
                                                                                                       reply_markup=InlineKeyboardMarkup([
